...
import (
	...
	"github.com/mdlayher/corerad/internal/netstate2"
	"golang.org/x/sys/unix"
)

func TestLinuxIntegrationWatcherWatch(t *testing.T) {
	...
	w := netstate2.NewWatcher()
	watchC := w.Subscribe(dummy)
	...
	// TODO: verify the actual changes!
}
