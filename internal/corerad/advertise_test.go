	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ad := &Advertiser{
				...
				// Stub out fields with bare minimum values to keep things working.
				ifi: &net.Interface{Name: "test0"},
				ll:  log.New(ioutil.Discard, "", 0),
				mm:  NewAdvertiserMetrics(nil),

				// No need to check any system parameters.
				getIPv6Forwarding: func(_ string) (bool, error) { return true, nil },
				setIPv6Autoconf:   func(_ string, _ bool) (bool, error) { return false, nil },
			}
